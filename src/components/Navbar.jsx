...
export const Navbar = () => {
  ...
  return (
    <nav
      className={cn(
        "fixed w-full z-50 transition-all duration-300", // ✅ increased z-index for navbar itself
      ...
      <div className="container flex items-center justify-between">
        ...
        >
          <span className="relative z-10">
            <span className="text-glow text-foreground"> AyanTech </span>{" "}
            Portfolio
          </span>
        </a>
        ...
        <div
          className={cn(
            ...
            isMenuOpen
              ...
              : "opacity-0 pointer-events-none" // ✅ ensures hidden menu does NOT block clicks
          )}
        >
